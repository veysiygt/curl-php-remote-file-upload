...
curl_setopt($start,CURLOPT_RETURNTRANSFER,true);//If the operation is true, it does not print all incoming data on the screen; if it is false, it prints the incoming data
